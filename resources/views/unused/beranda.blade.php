                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#services">Katalog Barang</a></li>
                            <li class="scroll-to-section"><a href="#frequently-question">Login</a></li>
                        </ul>
